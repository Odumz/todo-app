        ...
        <div class="tw-flex tw-flex-col">
            <div class="">
                <div class="tw-bg-indigo-600 tw-mb-3 tw-mx-auto tw-w-3/6 md:tw-w-2/3">
                    <div class="tw-max-w-7xl tw-mx-auto tw-py-3 tw-px-3 sm:tw-px-6 lg:tw-px-10 ">
                        ...
                        <div class="tw-w-0 tw-flex-1 tw-flex tw-items-center">
                            ...
                            <p class="tw-ml-3 tw-font-medium lg:tw-px-48 md:tw-px-8 sm:tw-px-2 tw-text-white tw-truncate">
                            <span class="md:tw-hidden">
                                Todo Application
                            </span>
                            <span class="tw-hidden md:tw-inline">
                                Todo Application. Keep a neat schedule!
                            </span>
                            </p>
                        </div>
                        </div>
