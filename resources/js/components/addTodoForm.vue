    ...
    <div class="container">
        <div class="tw-mb-4">
            ...
            <div class="tw-flex tw-mt-4">
                <input v-model="todo.title" class="tw-ring-1 tw-appearance-none tw-rounded-full tw-bg-blue-100 tw-border tw-border-green-300 hover:tw-border-green-500 focus:tw-border-green-500 tw-py-2 tw-px-3 tw-mr-4 tw-text-gay-800" placeholder="Add Todo"/>
